...
const FALLBACK_PROJECTS = [
  ...
  {
    _id: "static-4",
    title: "GitHub RAG Bot",
    desc: "An AI-powered repository assistant that pulls public GitHub code and uses Groq + LlamaIndex to let you chat with any codebase in real-time via a Streamlit interface.",
    tags: ["Python", "Groq", "LlamaIndex", "RAG", "Streamlit"],
    accent: "#0ea5e9",
    githubLink: "https://github.com/mehwishmubeen-2/github-RAG",
    liveLink: "https://app-rag-zkfw8mqwgpksn9bvm6yres.streamlit.app/"
  },
  {
    _id: "static-5",
    title: "PDF RAG Chatbot",
    desc: "A Retrieval-Augmented Generation chatbot that lets users upload PDF documents and ask contextual questions, powered by Streamlit, Groq (Llama 3), and FAISS vector search.",
    tags: ["Python", "Groq", "Llama 3", "RAG", "FAISS", "Streamlit"],
    accent: "#10b981",
