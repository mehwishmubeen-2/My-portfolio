...
function Chatbot() {
  ...
  // Start with a friendly AI welcome message
    ...
    <div className="chat-enhanced-root">
      ...
      <main className="chat-main-interface">
        <div className="chat-interface-header">
          ...
          <p>Powered by dynamic database insights from MongoDB</p>
        </div>
      ...
      {/* ── STYLES ── */}
      <style>{`
        /* Import homepage fonts to ensure matching typography */
        @import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap');

        .chat-enhanced-root {
          /* Variable Definitions Matching Home Page */
          --bg: #080b11;
          --surface: #111820;
          --border: rgba(255,255,255,0.07);
          --text: #e8eaf0;
          --muted: #7a8394;
          --accent: #6d5cff; /* Homepage Purple */
          --accent2: #00e5c0; /* Homepage Teal */
        ...
        .user-wrapper .message-bubble-enhanced {
          background: linear-gradient(135deg, var(--accent), #5848d9); /* Purple gradient */
          color: white;
